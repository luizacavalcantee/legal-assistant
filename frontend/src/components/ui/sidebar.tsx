    ...
    return (
      <button
        ...
        className={cn(
          ...
          "group-data-[collapsible=offcanvas]:translate-x-12 group-data-[collapsible=icon]:flex",
          className
        )}
        {...props}
      />
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:[[data-side=left][data-collapsible=icon]_&]:ml-[--sidebar-width-icon] md:[[data-side=right][data-collapsible=icon]_&]:mr-[--sidebar-width-icon]",
        className
      )}
      {...props}
    />
  ...
  ({ className, ...props }, ref) => {
    return (
      <hr
        ...
        className={cn("mx-2 w-auto border-sidebar-border group-data-[collapsible=icon]:mx-2", className)}
        {...props}
      />
    )
  }
